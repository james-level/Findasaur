...
class Autocomplete extends Component {
  ...
  static defaultProps = {
    ...
    renderTextInput: props => <TextInput underlineColorAndroid='transparent' {...props} style={{color: 'white', fontFamily: 'PoiretOne-Regular', textAlign: 'center', fontSize: 16, marginTop: 18, marginBottom: 18}} />,
