{/*NB: Social Media 'sharing' (react-native-share) section not working. Looks like a library issue. Errors message:
"undefined is not an object (evaluating 'reactNative.NativeModules.RNShare.FACEBOOK')"
------------------------------------------------------------------------------------*/}
...
AppRegistry.registerComponent('TestShare', () => ShareItem);
*/}
